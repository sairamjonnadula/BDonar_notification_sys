...
<tr><td class="lefttd" align="center">Detail</td><td><textarea name="t7"></textarea></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td><td><input type="submit" value="SEND" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr></table>
         
<!--<?php 
if(isset($_POST['sbmt'])){
 $name = $_POST['t1']; 
 $email = 'jnssr1997@gmail.com';
 $to = $_POST['t5']; 
 $subject = 'Blood required'; 
 $body = $_POST['t7']; 
 //$adminwebsite="jnssr1997@gmail.com";
